...
And then, we are done! The final code is on this [repository](https://github.com/franreysaycon/karma-chameleon) or check out this website. Feel free to do whatever you want with it. 
